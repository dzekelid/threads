...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/threads/master/_listings/mattermost/apis.md
...
- name: Mattermost API Reference - Get a thread
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/threads/master/_listings/mattermost/postspost-idthread-get-openapi.md
- name: Mattermost API Reference - Get a thread
  x-api-slug: postspost-idthread-get
  description: |-
    Get a post and the rest of the posts in the same thread.
